...
On our site, copy the relevant bits, which is everything *after* **<domain> 3600 IN DS**, of the DS record to the DS record page in your domain admin (you can find that at https://iwantmyname.com/dashboard/domains/dnssec/<**domain name in question**>)
