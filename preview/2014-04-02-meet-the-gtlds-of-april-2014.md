...
Generic top-level domains (gTLDs) are coming out at a consistent pace now, with new delegations, launch dates and prices being announced every week. So instead of weekly posts announcing long lists of news, we'll keep it to one post (just like this one!) on the first of each month. 
