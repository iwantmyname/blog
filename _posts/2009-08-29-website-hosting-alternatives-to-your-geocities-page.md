...
These services offer the option to use a custom domain name and can be configured using our [real-time DNS editor](https://iwantmyname.com/blog/2009/06/real-time-dns-management-for-your-domains.htm "Real-time DNS editor") (don't worry about it, we can help you with the setup):
