...
Usually country code top-level domains (ccTLDs) such as [.DE (Germany)]() or [.ES (Spain)]() cannot be targeted to an international audience but there are a [few exceptions](http://support.google.com/webmasters/bin/answer.py?hl=en&answer=1347922):
